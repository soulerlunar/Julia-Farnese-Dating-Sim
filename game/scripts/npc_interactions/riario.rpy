label riario_d1:
    ...
    j_int "I wonder if he remembers me. The real me, that is. We used to party together before the election consumed the thoughts of everyone in Italy, and he’s always been rather fun to hang around."
    ...
    label .c1:
        ...
        riario.c "I don’t see how beauty has anything to do with it. And my sister-in-law, Caterina Sforza, is the obvious choice for is papal hostess. She’s done it before, and is beloved by Rome."

        julia "…Of course, Your Eminence. Though, if I may, the Farnese family is of ancient and noble Roman blood. This would be a sure way to win Rome’s favor, especially given your uncle’s ties to the French."
    ...
    label .c2:
        ...
        julia "Well, as a vote counter I have certain…access that others, such as yourself, do not. I have overheard many of the cardinals’ conversations, and because I know which way they are voting, I can offer you some insight as to who would be best to pull to your uncle’s side."

        riario.c "Interesting…It could be a worthwhile deal, though I expect you’d want something in return."

        julia "Well my cousin, Julia Farnese, is an exceptional young woman, and I’ve heard others say she is the most beautiful woman in Italy. It would be a great boon to the Farnese family and to yours if she were to be your uncle’s papal hostess."
